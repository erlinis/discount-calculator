   ...
   return(
     <div className="bg-teal-lightest shadow-md rounded">
        <div className="flex justify-end">
          <div className="rounded-l-lg bg-red p-3 pl-8 mt-3 text-white"> {discount} % OFF </div>
        </div>
        ...
        <div className="items-center">
         <div className="bg-teal-lightest p-3 rounded-sm justify-between">
           <p className="text-red-light text-lg line-through"> Price: {formatNumber(price)} </p>
            <div className="mb-2">
              <div className="text-teal-darker font-bold text-4xl mb-2 p-6"> {formatNumber(salePrice)} </div>
